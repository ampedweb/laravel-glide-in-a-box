...
class CropTest extends TestCase
{
    ...
    {
        $this->assertEquals($this->glideUrl, $this->glideUrl->cropToPosition(1, 2, HasCrop::$CROP_BOTTOM_LEFT));
    }
    
    public function testCropToPositionSetsCorrectValues()
    {
        $this->glideUrl->cropToPosition(100, 200, HasCrop::$CROP_BOTTOM_LEFT);
